        ...
        <div className="row justify-content-between">
          ...
          <div className="col-md-3">
            <div className="partners">
              ...
              <span className="aeup"><a target="_blank" href="https://www.aeup.eu/"><img src="/assets/aeup-white.png" alt="Association of European University Presses"/></a></span>
